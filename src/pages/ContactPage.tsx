      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-emerald-900 text-white rounded-2xl p-6 border border-emerald-800 space-y-3 relative overflow-hidden">
          ...
          <div className="lg:col-span-7 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm space-y-6">
            ...
            {!formSent ? (
              <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                ...
                <button
                  type="submit"
                  className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3.5 rounded-xl text-sm transition-colors shadow-sm flex items-center justify-center gap-2"
                >
