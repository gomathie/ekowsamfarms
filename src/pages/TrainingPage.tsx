            ...
            >
              <div>
                <div className="relative h-56 overflow-hidden bg-slate-100">
                  ...
                  <span className="absolute top-4 left-4 bg-amber-500 text-slate-950 text-[11px] font-black px-2.5 py-1 rounded shadow-xs uppercase tracking-wider">
                    {ws.category}
                  </span>
                  <span className="absolute top-4 right-4 bg-emerald-900/90 text-emerald-200 text-xs font-bold px-2.5 py-1 rounded border border-emerald-700">
              ...
              <div className="p-6 pt-0 border-t border-slate-100 mt-4 space-y-3">
                ...
                <button
                  ...
                  className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 rounded-xl text-xs transition-colors shadow-xs flex items-center justify-center gap-2"
                >
            ...
            {!registerSuccess ? (
              <div>
                <div className="p-5 bg-emerald-900 text-white">
                  ...
                  <p className="text-xs text-emerald-200 mt-1">Fee: GH¢ {selectedWorkshop.feeGHS} | Date: {selectedWorkshop.date}</p>
                </div>
                ...
                <form onSubmit={handleRegisterSubmit} className="p-6 space-y-4 text-xs">
                  ...
                  <div className="p-3 bg-emerald-50 rounded-xl border border-emerald-200 space-y-1">
                    <p className="font-bold text-emerald-900">Registration Includes:</p>
                    <p className="text-emerald-800">• MoFA-Recognized Certificate of Completion</p>
                    <p className="text-emerald-800">• Starter Stock Vouchers & Comprehensive Handbook</p>
                    <p className="text-emerald-800">• Buffet Farm Lunch & Alumni Mentorship Access</p>
                  </div>
              ...
              <div className="p-8 text-center space-y-4">
                ...
                <div className="p-3 bg-amber-50 border border-amber-200 rounded-xl text-left text-xs space-y-1">
                  ...
                  <p className="text-amber-800">Please send GH¢ {selectedWorkshop.feeGHS} via MTN Mobile Money to <strong>024 123 4567 (Ekow Sam Farms)</strong> with Reference: <strong>WORKSHOP-{registrationForm.name.split(' ')[0]}</strong>.</p>
                </div>
                <button
                  onClick={() => setSelectedWorkshop(null)}
