            ...
            >
              <div>
                <div className="relative h-56 overflow-hidden bg-slate-100">
                  ...
                  <span className="absolute top-4 right-4 bg-blue-900/90 text-blue-200 text-xs font-bold px-2.5 py-1 rounded border border-blue-700">
              ...
              <div className="p-6 pt-0 border-t border-slate-100 mt-4 space-y-3">
                ...
                <button
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-xl text-xs transition-colors shadow-xs flex items-center justify-center gap-2"
                >
            ...
            {!registerSuccess ? (
              <div>
                <div className="p-5 bg-blue-900 text-white">
                  ...
                  <p className="text-xs text-blue-200 mt-1">Fee: GH¢ {selectedWorkshop.feeGHS} | Date: {selectedWorkshop.date}</p>
                </div>
                ...
                <form onSubmit={handleRegisterSubmit} className="p-6 space-y-4 text-xs">
                  ...
                  <div className="p-3 bg-blue-50 rounded-xl border border-blue-200 space-y-1">
                    <p className="font-bold text-blue-900">Registration Includes:</p>
                    <p className="text-blue-800">• MoFA-Recognized Certificate of Completion</p>
                    <p className="text-blue-800">• Starter Stock Vouchers & Comprehensive Handbook</p>
                    <p className="text-blue-800">• Buffet Farm Lunch & Alumni Mentorship Access</p>
                  </div>
