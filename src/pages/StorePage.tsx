          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="relative w-full md:w-80">
              ...
              <input
                ...
                className="w-full text-xs pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:border-emerald-600 bg-slate-50"
              />
            </div>
            ...
            <div className="flex items-center gap-2 w-full md:w-auto justify-end">
              ...
              <select
                ...
                className="text-xs px-3 py-2 rounded-xl border border-slate-200 bg-slate-50 font-semibold focus:outline-none focus:border-emerald-600"
              >
              ...
              >
                <div>
                  <div className="relative h-52 overflow-hidden bg-slate-100">
                    ...
                    />
                    <span className="absolute top-3 left-3 bg-emerald-900 text-emerald-100 text-[10px] font-bold px-2.5 py-1 rounded uppercase tracking-wider">
                      {product.category}
                    </span>
                    {product.featured && (
                ...
                <div className="p-5 pt-0 space-y-3">
                  ...
                  <button
                    ...
                    className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 rounded-xl text-xs transition-colors shadow-xs flex items-center justify-center gap-1.5 active:scale-95"
                  >
