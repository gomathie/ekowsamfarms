            ...
            >
              <div>
                ...
                <div className="p-6 space-y-3">
                  ...
                  <h3 className="font-bold text-slate-900 text-lg group-hover:text-emerald-700 transition-colors font-serif leading-snug">
                    {post.title}
                  </h3>
              ...
              <div className="p-6 pt-0 border-t border-slate-100 mt-4">
                <button
                  ...
                  className="w-full bg-slate-100 hover:bg-emerald-600 text-slate-800 hover:text-white font-bold py-2.5 rounded-xl transition-colors text-xs flex items-center justify-center gap-1.5"
                >
            ...
            <div className="p-6 space-y-4 text-xs sm:text-sm text-slate-700 leading-relaxed max-h-[400px] overflow-y-auto">
              ...
              <div className="pt-4 border-t border-slate-100 flex flex-wrap gap-1.5">
                {selectedPost.tags.map((tag, idx) => (
                  <span key={idx} className="bg-emerald-50 text-emerald-900 text-[10px] font-bold px-2.5 py-1 rounded border border-emerald-200">
                    #{tag}
                  </span>
                ))}
              </div>
