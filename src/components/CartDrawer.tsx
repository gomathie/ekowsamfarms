          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-4 divide-y divide-slate-100">
            {cartItems.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-center p-6 text-slate-400">
                ...
                <button
                  onClick={onClose}
                  className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-sm px-5 py-2.5 rounded-lg shadow-sm"
                >
                  Start Shopping
                </button>
              </div>
            ...
            <div className="p-5 bg-slate-50 border-t border-slate-200 space-y-4">
              <div className="space-y-1.5 text-sm">
                ...
                <div className="pt-2 border-t border-slate-200 flex justify-between items-baseline">
                  ...
                  <span className="font-black text-xl text-emerald-800">GH¢ {subtotalGHS.toFixed(2)}</span>
                </div>
              </div>

              <div className="p-2.5 bg-emerald-100/70 border border-emerald-200 rounded-lg flex items-center gap-2 text-xs text-emerald-900">
              ...
              <button
                onClick={onCheckout}
                className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3.5 rounded-xl shadow-md transition-all flex items-center justify-center gap-2 text-base active:scale-98"
              >
